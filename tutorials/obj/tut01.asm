...
; location of global variables
  ...
  %define global_sfx_jump 3378
  %define global_prev_a 3418
  %define global_prev_b 3419
  %define global_prev_x 3420
...
__if_4803_start:
  mov R0, [BP+2]
  igt R0, 0
  jf R0, __LogicalAnd_ShortCircuit_4808
  mov R1, [BP-1]
  ile R1, 0
  and R0, R1
__LogicalAnd_ShortCircuit_4808:
  jf R0, __if_4803_end
  mov R0, 1
  jmp __function_just_pressed_return
__if_4803_end:
  mov R0, 0
__function_just_pressed_return:
  pop R1
  mov SP, BP
  pop BP
  ret
...
__while_4841_start:
__while_4841_continue:
  mov R0, 1
  jf R0, __while_4841_end
  mov R1, 0
  mov [SP], R1
