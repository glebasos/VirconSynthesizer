...
; location of global variables
  ...
  %define global_bass_rows 3378
  %define global_lead_rows 3386
  %define global_song 3394
  %define global_prev_start 3440
...
__if_4748_start:
  ...
  mov R0, [R1]
  igt R0, 0
  jf R0, __LogicalAnd_ShortCircuit_4757
  mov R1, [global_synth_seq_row]
  and R1, 1
  cib R1
  and R0, R1
__LogicalAnd_ShortCircuit_4757:
  jf R0, __if_4748_end
  mov R0, [BP-2]
  mov R2, [BP-1]
  iadd R2, 45
...
__function_main:
  ...
  mov R0, 0
  mov [global_prev_start], R0
__while_4919_start:
__while_4919_continue:
  mov R0, 1
  jf R0, __while_4919_end
  mov R1, 0
  mov [SP], R1
...
__if_4927_start:
  mov R0, [BP-1]
  igt R0, 0
  jf R0, __LogicalAnd_ShortCircuit_4932
  mov R1, [global_prev_start]
  ile R1, 0
  and R0, R1
__LogicalAnd_ShortCircuit_4932:
  jf R0, __if_4927_end
__if_4936_start:
  mov R0, [global_synth_seq_playing]
  cib R0
  jf R0, __if_4936_else
  call __function_synth_seq_stop
  jmp __if_4936_end
__if_4936_else:
  mov R1, global_song
