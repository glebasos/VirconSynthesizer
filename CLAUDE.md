...
| `README.md` | User-facing overview + quick start. Keep in sync with `synth.h`. |
| `docs/` | `concepts.md` (mental model + hardware limits) + `api-reference.md` (full API). |
| `tutorials/` | 3 progressive guides + runnable ROMs (`tutNN.c/.xml`, `build.sh`). Example code is compile-checked. |
